...
model = BaggingClassifier(LinearSVC(class_weight='balanced'), max_samples=1.0 / n_estimators, n_estimators=n_estimators)
...
model_name = 'SignalP_LinearSVC_wind_final'+str(window_size)
