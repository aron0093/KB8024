...
scores_table.to_csv(outpath+'model_stats/'+'SignalP_LinearSVC_wind_final_bagging'+str(window_size)+'data.csv')    
...
plt.figure(1).savefig(outpath+'model_stats/'+'SignalP_LinearSVC_wind_final_bagging'+str(window_size)+'data_plot.png')
  
plt.figure(2)
plot_confusion_matrix(cm, classes, normalize=True)
plt.figure(2).savefig(outpath+'model_stats/'+'SignalP_LinearSVC_wind_final_bagging'+str(window_size)+'confusion_plot.png')
...
model_name = 'SignalP_LinearSVC_wind_final_bagging'+str(window_size)
