...
scores_table.to_csv(outpath+'model_stats/'+'Random_Forest_wind'+str(window_size)+'_'+pssm_type+'.csv')    
...
plt.figure(1, figsize=(20,10)).savefig(outpath+'model_stats/'+'Random_Forest_wind'+str(window_size)+'_'+pssm_type+'_plot.png')
  
plt.figure(2)
plot_confusion_matrix(cm, classes, normalize=True)
plt.figure(2, figsize=(20,10)).savefig(outpath+'model_stats/'+'Random_Forest_wind'+str(window_size)+'_'+pssm_type+'_conf.png')
...
model_name = 'Random_Forest_wind'+str(window_size)+'_'+pssm_type
